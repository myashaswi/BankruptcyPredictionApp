...
if page.startswith("1"):
    ...
    st.write("Rebecca Bubis; Yashaswi Maguluri; Brendan Wilcox")
    st.markdown(f"<h2 style='color:{red};'>Rebecca Bubis, Yashaswi Maguluri, Brendan Wilcox?</h2>", unsafe_allow_html=True)
